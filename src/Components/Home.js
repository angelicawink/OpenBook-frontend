...
class Home extends Component {
    ...
    if (this.state.snapshotLogged) {
      return (
        <div className="moment-box">
          ...
          />
          <div>
            <button className="chart-another" onClick={this.snapshotLogged}>
              chart another
            </button>
          </div>
        </div>
      ...
      return (
        <MomentForm
          ...
          addMoment={this.props.addMoment}
          snapshotLogged={this.snapshotLogged}
    ...
    if (this.props.user.entries.length === 0) {
      ...
      if (!this.state.showNewEntryForm) {
        return (
          <Diary
            {...this.props}
            togglePrivacyInState={this.props.togglePrivacyInState}
            user={this.props.user}
  ...
  renderPieChartContents = () => {
    if (this.props.user.moments.length === 0 || !this.props.posPieChartData) {
      ...
      return (
        <PieChart
          negPieChartData={this.props.negPieChartData}
          posPieChartData={this.props.posPieChartData}
        />
      );
    }
  };
