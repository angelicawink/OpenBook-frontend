...
renderIcon = () => {
  ...
  let checkmark = "https://storage.needpix.com/rsynced_images/yes-2419247_1280.png"
    ...
    return(
      ...
      <OverlayTrigger
        ...
        <h4
          ...
          onMouseOver={(entry) => this.props.setSelectedEntry(this.props.result)}
        ...
        {this.props.result.created_at.slice(0,9) + " - "} {this.props.result.content.slice(0, 60)+'.....'}
