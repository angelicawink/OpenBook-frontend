      ...
      <>
        {this.state.showPoemForm ? (
          <div className="container poetry">
            ...
            />
            <RhymeFinder addWord={this.addWord} />
          </div>
        ) : (
          <div className="container poem-done">
            <h2>Wow. Amazing.</h2>
            <button className="new-entry" onClick={this.togglePoetryDisplay}>
              Write another
            </button>
            <button
              className="new-entry"
              onClick={() => this.props.history.push("/wallow")}
            >
              Go to my poems
            </button>
          </div>
