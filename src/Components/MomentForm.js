...
class MomentForm extends Component {
  ...
  handleSubmit = event => {
    ...
    fetchPostNewMoment(token, userID, feelingsID, settingID).then(data => {
    ...
    return (
      <>
        <form onSubmit={this.handleSubmit} className="snapshot">
          ...
          >
            <option value="1" className="val">
              I'm at work
            </option>
            <option value="2" className="val">
              I'm outdoors
            </option>
            <option value="3" className="val">
              I'm exercising
            </option>
            <option value="4" className="val">
              I'm just chillin
            </option>
            <option value="5" className="val">
              I'm socializing
            </option>
            <option value="6" className="val">
              I'm with family
            </option>
            <option value="7" className="val">
              I'm with my signicant other
            </option>
            <option value="8" className="val">
              I'm doing something else
            </option>
          </select>

          <div className="form-group">
            <button id="new-moment" type="submit">
              chart it
            </button>
          </div>
        </form>
